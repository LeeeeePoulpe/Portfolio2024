  ...
  <div class="text-justify">
    <div class="flex flex-col md:flex-row mb-10">
      <div class="max-w-[700px] flex flex-col gap-4">
        ...
        <p>
          Lors du second semestre du BUT informatique à l'IUT2 de Grenoble, nous avons réalisé par groupe de cinq
          un projet visant à développer une application de gestion d'évènements. Nous avions le choix sur le type
    ...
    <div class="flex flex-col gap-4 mb-10">
      ...
      <div class="flex flex-col gap-5 items-center">
        <p>
          L'objectif du projet était de nous faire comprendre toutes les étapes du déroulé d'un projet : de la
          réflexion à la réalisation en passant par la conception.
        </p>
        ...
        <p>
          ...
          réalisé une maquette pour nous aider. Le développement a été l'étape suivante. Enfin, nous avons
    ...
    <div class="flex flex-col gap-4 mb-10">
      ...
      <p>
        L'application finale est conforme aux maquettes et aux contraintes demandées par l'IUT.
        L'application permet de gérer les conférences,
        les intervenants, les participants et les salles. Nous avons réussi à développer cette application grâce à notre
        travail d'équipe et à notre répartition équitable des tâches en fonction des compétences de chacun. Nous avons
        également réussi à respecter les délais imposés par l'IUT.
      </p>
    </div>
    ...
    <div>
      ...
      <div class="flex flex-col md:flex-row items-center gap-5">
        ...
        <p>
          ...
          appris à travailler en équipe pour réaliser un projet. Ce projet nous a permis de mettre en pratique
          les connaissances acquises lors de notre formation tel que :
