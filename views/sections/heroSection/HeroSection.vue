<template>
  <div role="alert" class="alert alert-warning">
    ...
    <span>Le site est en cours de développement, certaines parties ne fonctionnent pas correctement</span>
  </div>
  <div class="flex flex-col justify-start sm:justify-center items-center hero-background p-3" :class="isDesktop ? 'h-screen' : 'hero-height'">
